...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={clsx("bg-background h-8 w-full shadow-none", className)}
      {...props}
    />
  );
}
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={clsx("bg-sidebar-border mx-2 w-auto", className)}
      {...props}
    />
  );
}
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={clsx("flex h-8 items-center gap-2 rounded-md px-2", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={clsx("group/menu-sub-item relative", className)}
      {...props}
    />
  );
}
